...
public class UserInput {
    ...
    public List<Employee> getSearchParameters() {
        Scanner scan = new Scanner(System.in);
        System.out.println("Searching for User? Enter the employee's full name, SSN, and/or Employee ID. Leave field blank to skip.");
        ...
        if (!idInput.isEmpty()) {
            try {
                ...
                System.out.println("Invalid ID entered. Skipping ID filter.");
            }
        }
        System.out.println("Finding Employees");
        List<Employee> employees = this.reportGenerator.generateEmployeeInfo(id, firstName, lastName, SSN);
        return employees;
    }
